...
class TestAuth:
    ...
    def test_auth_jwt(self, setup_state):
        ...
        fixed_user = User(uid=UUID('11d52aeb-0dc3-4a90-a8b8-27b061c49920'), email_address="stubbed_email@email.test").create(db_session)
    ...
    def test_get_scoped_user(self, setup_state):
        _, db_session  = setup_state
        flow = JWTTokenFlow(db_session)
        artificially_long_scoped_auth_token = ("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9."
