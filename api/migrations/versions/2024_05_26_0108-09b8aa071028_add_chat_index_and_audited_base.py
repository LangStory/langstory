...
def upgrade() -> None:
    ...
    op.add_column(
        "assistantmessage",
        sa.Column("last_updated_by", sqlmodel.sql.sqltypes.GUID(), nullable=True),
    )
    op.add_column(
        "assistantmessage", sa.Column("chat_index", sa.Integer(), nullable=False)
    )
    op.create_foreign_key(
        None, "assistantmessage", "user", ["last_updated_by"], ["uid"]
    )
    op.create_foreign_key(None, "assistantmessage", "user", ["created_by"], ["uid"])
    op.add_column(
        "chat", sa.Column("created_by", sqlmodel.sql.sqltypes.GUID(), nullable=True)
    )
    op.add_column(
        "chat",
        sa.Column("last_updated_by", sqlmodel.sql.sqltypes.GUID(), nullable=True),
    ...
    op.drop_constraint(
        "externalevent_chat_id_fkey", "externalevent", type_="foreignkey"
    )
    op.drop_column("externalevent", "chat_id")
    op.add_column(
        "project", sa.Column("created_by", sqlmodel.sql.sqltypes.GUID(), nullable=True)
    )
    op.add_column(
        "project",
        sa.Column("last_updated_by", sqlmodel.sql.sqltypes.GUID(), nullable=True),
    ...
    op.add_column(
        "systemmessage", sa.Column("chat_index", sa.Integer(), nullable=False)
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "externalevent_chat_id_fkey", "externalevent", "chat", ["chat_id"], ["uid"]
    )
